clear all 
clc
inputrawpath = 'InputLibrary/ValidationCycles/Unformatted_SCD/';
...
val_exp_num = {'ValModCDDC1.mat';'ValModCDDC2.mat';'ValModCDLA92x2.mat';'ValModCDSC04x4.mat';'ValModCDUDDSx2.mat';'Val_0.5C.mat';'Val_1C.mat';'Val_2C.mat'};
exp_num = val_exp_num;

filename_input_vector = {'validation_cycles_SCD.mat'};
for mm = 1:Num_groups
    ...
    Rc_exp_cell = {};
%     exp_num_cell = {};
    for zz = 1:length(val_exp_num) %Group_size(mm) 
...
%         exp_num_track = vertcat(exp_num_track,val_exp_num{exp_idx});
        ...
        % Load experiment
        exp_str = strcat(val_exp_num{exp_idx});
        load(strcat(inputrawpath,exp_str),'Current_exp','Time_exp','Voltage_exp','T_amb_sim','Rc');
