...
function param_table_plotter_ZTG(ci95,theta_0,theta_0_true,truth_param,bounds)
...
%     set(gcf,'Position',[234 3 564 695],'PaperPositionMode','auto');
    ...
    [~,~] = format_ticks(gca,' ', params(y_value),0:0.1:1,[],0,0,0.05,'FontSize',fs,'FontWeight','Bold');
