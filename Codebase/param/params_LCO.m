...
% Modified Jan 13, 2017 by Saehong Park
% Adjusted to CVM version for Bosch RTC
...
% Particle Radii
p.R_s_n = 8e-6;%10e-6;   % Radius of solid particles in negative electrode [m]
p.R_s_p = 5e-6;%10e-6;   % Radius of solid particles in positive electrode [m]

% Volume fractions
p.epsilon_s_n = 0.6;      % Volume fraction in solid for neg. electrode
p.epsilon_s_p = 0.5;      % Volume fraction in solid for pos. electrode

p.epsilon_e_n = 0.11;%0.3;   % Volume fraction in electrolyte for neg. electrode
...
p.D_s_n0 = 2.8e-14;%3.9e-14;  % Diffusion coeff for solid in neg. electrode, [m^2/s]
...
p.c_e0 = 1e3;              % Fixed electrolyte concentration for SPM, [mol/m^3]
